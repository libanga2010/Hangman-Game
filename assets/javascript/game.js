...
//Array of carwords
var carWords = ['acura', 'alfa romeo', 'ascari', 'audi', 'bentley', 'bmw', 'bugatti', 'buick',
  'cadillac', 'chevrolet', 'chrysler', 'corvette', 'dodge', 'ferrari', 'fiat', 'gmc',
  'hyundai', 'infiniti', 'jaguar', 'jaguar', 'jeep', 'kia', 'lamborghini', 'lexus', 'nissan', 'toyota',
  'ram', 'volkswagen', 'porshe'
];
...
function startGame() {
  ...
  currentWord = carWords[Math.floor(Math.random() * carWords.length)];
